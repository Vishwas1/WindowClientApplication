...
//        try
//        {
//            oo = deSerializer.Deserialize(json, typeof(object));
//        }
//        catch (Exception ex)
//        {
//        }
...
//    public List<DynamicJsonObject> DeserializeArrayType(string json)
//    {
//        object[] objLst = null;
//        List<DynamicJsonObject> DynObjLst = new List<DynamicJsonObject>();
//        DynamicJsonObject _obj = new DynamicJsonObject();
//        try
//        {
//            objLst = (object[])deSerializer.Deserialize(json, typeof(object));
//            foreach (object o in objLst)
//            {
//                _obj = (DynamicJsonObject)o;
//                DynObjLst.Add(_obj);
//            }
...
//        }
//        return DynObjLst;
//        //return deSerializer.Deserialize(json, typeof(object)) as List<DynamicJsonObject>;
//    }
